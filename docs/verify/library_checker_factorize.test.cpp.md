...
data:
  ...
  bundledCode: "#line 1 \"verify/library_checker_factorize.test.cpp\"\n#define PROBLEM\
...
layout: document
redirect_from:
- /verify/verify/library_checker_factorize.test.cpp
- /verify/verify/library_checker_factorize.test.cpp.html
